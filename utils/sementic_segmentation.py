...
import base64
import json
from typing import TypedDict, Literal, List, Annotated, Optional, Dict, Any
...
if __name__ == "__main__":
    ...
    if os.path.exists(input_image):
        ...
        semantic_segmentation_app.invoke(initial, config={"recursion_limit": 150})
    else:
...
#     2. **The Title Block**: Look DOWN. Is the text describing this drawing (e.g., "PLAN VIEW", "SCALE 1:50","LOOSE LINTEL SCHEDULE) visible?
...
#             safe_label = "".join(x for x in label if x.isalnum())
#             filename = f"{safe_label}.png"
#             final_pil.save(image_folder / filename)
...
#             os.makedirs(state['output_dir'], exist_ok=True)
#             filename = f"{safe_label}.png"
#             cropped_pil.save(image_folder / filename)
